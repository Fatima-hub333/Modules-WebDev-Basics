...
setTimeout(() => console.log(`In the end, they lived happily ever after.`), 1500)//5
console.log(`The princess's wicked stepmother put a curse on them before they could marry.`)//2
setTimeout(() =>console.log(`They got married on a beautiful summer's day.`), 1000)//4
